...
- (id)init {
    if (self = [super init]) {
        ...
        NSString *dataPath = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"myCoreData.sqlite"];
...
//修改数据根据名字修改数据
- (void)updataModelWithPer:(NSString *)perstring andObjAge:(NSNumber *)age {
